    ...
    <div class="login-wrapper">
        ...
        <div class="login-header">
            <div class="login-logo">
                <img src="{{ asset('images/logo.png') }}" alt="Shiloh Learning Center Logo">
            </div>
        ...
        <div class="login-card">
            ...
            <form class="login-form" action="{{ route('unified.login') }}" method="POST" id="loginForm">
                @csrf
        ...
        <div class="login-footer">
            ...
            <p class="login-copyright">&copy; {{ date('Y') }} Shiloh Learning Center</p>
        </div>
    </div>
