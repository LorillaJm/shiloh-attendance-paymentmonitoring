            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <span class="ml-2 font-medium text-gray-900 dark:text-gray-100"><?php echo e($student->student_no); ?></span>
                    </div>
                    <div>
                        <span class="text-sm text-gray-600 dark:text-gray-400">Name:</span>
                        <span class="ml-2 font-medium text-gray-900 dark:text-gray-100"><?php echo e($student->full_name); ?></span>
                    </div>
                    <div>
                        <span class="text-sm text-gray-600 dark:text-gray-400">Guardian:</span>
                        <span class="ml-2 font-medium text-gray-900 dark:text-gray-100"><?php echo e($student->guardian_name); ?></span>
                    </div>
                    <div>
                        <span class="text-sm text-gray-600 dark:text-gray-400">Contact:</span>
                        <span class="ml-2 font-medium text-gray-900 dark:text-gray-100"><?php echo e($student->guardian_contact); ?></span>
                    </div>
                </div>
            </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $enrollments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100"><?php echo e($enrollment->package->name); ?></h3>
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-4 p-4 bg-gray-50 dark:bg-gray-700 rounded">
                        <div>
                            ...
                            <div class="text-xl font-bold text-gray-900 dark:text-gray-100">₱<?php echo e(number_format($enrollment->total_fee, 2)); ?></div>
                        </div>
                        <div>
                            <div class="text-sm text-gray-600 dark:text-gray-400">Total Paid</div>
                            <div class="text-xl font-bold text-green-600 dark:text-green-400">₱<?php echo e(number_format($enrollment->total_paid, 2)); ?></div>
                        </div>
                        <div>
                            <div class="text-sm text-gray-600 dark:text-gray-400">Balance</div>
                            <div class="text-xl font-bold text-red-600 dark:text-red-400">₱<?php echo e(number_format($enrollment->remaining_balance_computed, 2)); ?></div>
                        </div>
                    </div>
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $enrollment->paymentSchedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="py-2 text-gray-900 dark:text-gray-100"><?php echo e($schedule->due_date ? $schedule->due_date->format('Y-m-d') : '-'); ?></td>
                                    <td class="text-right py-2 text-gray-900 dark:text-gray-100">₱<?php echo e(number_format($schedule->amount_due, 2)); ?></td>
                                    <td class="text-center py-2">
                                        <span class="px-2 py-1 rounded text-xs font-semibold
                                            <?php echo e($schedule->status === 'PAID' ? 'bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100' : 'bg-red-100 text-red-800 dark:bg-red-800 dark:text-red-100'); ?>">
                                            <?php echo e($schedule->status); ?>

                                        </span>
                                    </td>
                                    <td class="py-2 text-gray-900 dark:text-gray-100"><?php echo e($schedule->paid_at ? $schedule->paid_at->format('Y-m-d') : '-'); ?></td>
                                    <td class="py-2 text-gray-900 dark:text-gray-100"><?php echo e($schedule->payment_method ?? '-'); ?></td>
                                </tr>
