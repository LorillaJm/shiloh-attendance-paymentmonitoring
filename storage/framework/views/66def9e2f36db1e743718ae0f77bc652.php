        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                ...
                <div class="text-3xl font-bold text-red-600 dark:text-red-400 mt-2">
                    ₱<?php echo e(number_format($this->getSummary()['total_amount'], 2)); ?>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                ...
                <div class="text-3xl font-bold text-orange-600 dark:text-orange-400 mt-2">
                    <?php echo e($this->getSummary()['total_count']); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\HUAWEI\OneDrive\shiloh-attendance-paymentmonitoring\resources\views/filament/pages/due-overdue-report.blade.php ENDPATH**/ ?>