    ...
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="max-w-md w-full text-center">
            ...
            <p class="text-gray-600 dark:text-gray-400 mb-8">
                <?php echo e($message ?? 'You do not have permission to access this resource.'); ?>
...
<?php /**PATH C:\Users\pc1\Downloads\Attendance-Payment\resources\views/errors/403.blade.php ENDPATH**/ ?>